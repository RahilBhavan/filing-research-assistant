...
|---|---|---:|---|
| Regression and evidence tests | `python3 -m unittest discover -s tests -q` | 0 | 60 tests passed, including original 41 |
...
The local API check required network sandbox permission to contact localhost. The server required permission to bind its localhost port. No external publishing occurred.
